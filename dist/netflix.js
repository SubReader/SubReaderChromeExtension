...
/***/ function(module, exports, __webpack_require__) {
	...
	var _communication = __webpack_require__(53);

	var _utils = __webpack_require__(55);

	var supportedLanguages = ["da", "en", "de", "fr", "sv", "no"];

	function getLanguage() {
	  return (0, _utils.find)(".player-timed-text-tracks > .player-track-selected").then(function (el) {
	    return el.dataset.id.split(";")[2];
	  });
	}

	function getTitle() {
	  return (0, _utils.find)(".player-status-main-title").then(function (el) {
	    return el.innerText;
	  });
	}

	function getStatus() {
	  return (0, _utils.find)(".player-status");
	}

	function search() {
	  return (0, _utils.find)("video").then(function (video) {
	    return { video: video };
	  }).combine((0, _utils.find)(".player-timedtext"), function (acc, timedTextEl) {
	    return _extends({}, acc, { timedTextEl: timedTextEl });
	  });
	}
	...
	var search$ = (0, _communication.on$)(["search"]);
	...
	var meta$ = search$.flatMap(function () {
	  return _rx.Observable.create(function (observer) {
	...
	var cues$ = meta$.map(function (_ref) {
	  var video = _ref.video;
	  var timedTextEl = _ref.timedTextEl;

	  return _rx.Observable.create(function (observer) {
	    var previousText = "";
	    function updateHandler() {
	      var innerText = timedTextEl.innerText;
	      var text = (0, _utils.escapeHTML)(innerText);
	...
	(0, _communication.emit)(cues$, "cues");
	(0, _communication.emit)(info$, "info");
...
/***/ function(module, exports, __webpack_require__) {
	...
	function on$(actions, fn) {
	  return _rx.Observable.create(function (observer) {
	    on(actions, function (action, payload, sender, sendResponse) {
	      if (fn) {
...
/***/ function(module, exports) {
	...
	function Maybe(item) {
	  return {
	    ...
	    combine: function combine(_Maybe, fn) {
	      return _Maybe.then(function (b) {
	        return fn(item, b);
	      });
	    }
	  };
	...
	function find(query) {
	  var results = toArray(document.querySelectorAll(query)).slice(0, 1);
